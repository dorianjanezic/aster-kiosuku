    ...
    useEffect(() => {
        async function fetchCycles() {
            try {
                ...
                const parsed = SlimCyclesResponseSchema.parse(data)
    ...
    if (loading) {
        return (
            <main>
                ...
                <div className="text-sm text-muted-foreground">Loading cycles data...</div>
            </main>
        )
    }
        ...
        return (
            <main>
                ...
                <div className="text-sm text-muted-foreground">
                    The cycles API is not available. This requires a backend service to display trading data.
                </div>
            </main>
        )
    }
